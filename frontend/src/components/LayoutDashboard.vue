...
const menuSections = ref([
    ...
    },
    {
        ...
        items: [
            ...
            {
                name: Translation.getTranslation('components.sidebar.eula'),
                icon: ScaleIcon,
                href: '/admin/eula',
            ...
            },
            {
                ...
                active: isActiveRoute(['/admin/announcements']),
            },
            {
                name: Translation.getTranslation('components.sidebar.addons'),
                icon: AddonsIcon,
                href: '/admin/addons',
            ...
            {
                name: Translation.getTranslation('components.sidebar.apikeys'),
                icon: ApiKeysIcon,
                href: '/admin/apikeys',
                active: isActiveRoute(['/admin/apikeys']),
            },
            {
                name: Translation.getTranslation('components.sidebar.users'),
                icon: UsersIcon,
                href: '/admin/users',
            ...
            {
                name: Translation.getTranslation('components.sidebar.settings'),
                icon: SettingsIcon,
                href: '/admin/settings',
