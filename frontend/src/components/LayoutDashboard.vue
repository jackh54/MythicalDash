...
const menuSections = ref([
    {
        title: 'General',
        items: [
            { name: 'Dashboard', icon: LayoutDashboardIcon, href: '/', active: isActiveRoute(['/']) },
            { name: 'Tickets', icon: TicketIcon, href: '/ticket', active: isActiveRoute(['/ticket']) },
        ]
    },
    {
        title: 'Administration',
        items: [
            { name: 'Dashboard', icon: LayoutDashboardIcon, href: '/admin', active: isActiveRoute(['/admin']) },
            { name: 'EULA', icon: ScaleIcon, href: '/admin/eula', active: isActiveRoute(['/admin/eula']) },
            { name: 'Annoucments', icon: RssIcon, href: '/admin/annoucments', active: isActiveRoute(['/admin/annoucments']) },
            { name: 'Addons', icon: AddonsIcon, href: '/admin/addons', active: isActiveRoute(['/admin/addons']) },
            { name: 'Backups', icon: BackupIcon, href: '/admin/backups', active: isActiveRoute(['/admin/backups']) },
            { name: 'Logs', icon: LogsIcon, href: '/admin/logs', active: isActiveRoute(['/admin/logs']) },
            { name: 'Language Editor', icon: LanguageIcon, href: '/admin/languages', active: isActiveRoute(['/admin/languages']) },
            { name: 'Api Keys', icon: ApiKeysIcon, href: '/admin/apikeys', active: isActiveRoute(['/admin/apikeys']) },
            { name: 'Users', icon: UsersIcon, href: '/admin/users', active: isActiveRoute(['/admin/users']) },
            { name: 'Roles', icon: TerminalIcon, href: '/admin/roles', active: isActiveRoute(['/admin/roles']) },
            { name: 'Tickets', icon: HelpIcon, href: '/admin/tickets', active: isActiveRoute(['/admin/tickets']) },
            { name: 'Settings', icon: SettingsIcon, href: '/admin/settings', active: isActiveRoute(['/admin/settings']) },
        ]
    },
