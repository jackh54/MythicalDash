        ...
        <div class="h-full px-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <button
              ...
              class="p-2 hover:bg-gray-800/50 rounded-lg relative"
            >
      ...
      >
        <div class="flex justify-between items-center text-gray-400 text-sm px-6">
          ...
          <div class="flex gap-4">
            <RouterLink to="/terms" class="hover:text-purple-400 transition-colors"
              >Terms</RouterLink
            >
            <RouterLink to="/privacy" class="hover:text-purple-400 transition-colors"
              >Privacy</RouterLink
            >
            <RouterLink to="/support" class="hover:text-purple-400 transition-colors"
              >Support</RouterLink
            >
          </div>
        </div>
...
import Settings from '@/mythicalclient/Settings.ts'
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ScaleIcon,
        href: '/admin/eula',
        active: isActiveRoute(['/admin/eula']),
      },
      {
        name: 'Annoucments',
        icon: RssIcon,
        href: '/admin/annoucments',
        active: isActiveRoute(['/admin/annoucments']),
      },
      {
        name: 'Addons',
        icon: AddonsIcon,
        href: '/admin/addons',
        active: isActiveRoute(['/admin/addons']),
      },
      {
        name: 'Backups',
        icon: BackupIcon,
        href: '/admin/backups',
        active: isActiveRoute(['/admin/backups']),
      },
      { name: 'Logs', icon: LogsIcon, href: '/admin/logs', active: isActiveRoute(['/admin/logs']) },
      {
        ...
        active: isActiveRoute(['/admin/languages']),
      },
      {
        name: 'Api Keys',
        icon: ApiKeysIcon,
        href: '/admin/apikeys',
        active: isActiveRoute(['/admin/apikeys']),
      },
      {
        name: 'Users',
        icon: UsersIcon,
      ...
      },
      {
        ...
        icon: TerminalIcon,
        href: '/admin/roles',
        active: isActiveRoute(['/admin/roles']),
      },
      {
        name: 'Tickets',
        icon: HelpIcon,
        href: '/admin/tickets',
        active: isActiveRoute(['/admin/tickets']),
      },
      {
        name: 'Settings',
        icon: SettingsIcon,
