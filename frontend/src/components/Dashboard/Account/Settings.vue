<template>
    ...
    <!-- Settings Form -->
    <CardComponent cardTitle="Deactivate Account"
    ...
    <CardComponent cardTitle="Deactivate Account"
        ...
        <div class="space-y-4">
            ...
            <br>
            <button type="button" class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded text-sm font-medium transition-colors">Deactivate account</button>
        </div>
    </CardComponent>
</template>
