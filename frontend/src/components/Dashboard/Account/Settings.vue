<template>
  ...
  >
    <div class="space-y-4">
      ...
      <p class="text-sm text-gray-300">
        Once you delete your account, there is a 30 days window for you to contact support to
        recover your account. After 30 days, your account will be permanently disabled.
      </p>
      <p class="text-sm text-gray-300">
        This means that your account will be marked as deleted BUT we reserve the right to keep all
        the data for legal reasons. You may open a ticket for your data to be anonymized due to
        GDPR!
      </p>
      <br />
      <button
