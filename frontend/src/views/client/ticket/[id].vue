...
const ticket = ref({
    ...
    description:
        'I am unable to log into my account. It says my password is incorrect, but I am sure I am using the right password.',
    messages: [
        {
            id: 1,
            content: 'Hello, I cannot access my account. Can you help?',
            isClient: true,
        ...
        },
        {
            id: 2,
            content:
                "Hi there! I'd be happy to help. Can you please provide me with your username or email address associated with the account?",
            isClient: false,
        ...
        },
        {
            ...
            isClient: true,
            timestamp: '2023-05-10 14:37',
        },
        {
            id: 4,
            content:
                "Thank you for providing that information. I've checked your account, and it seems there were multiple failed login attempts. For security reasons, your account has been temporarily locked. I've sent a password reset link to your email. Please check your inbox and follow the instructions to regain access to your account.",
            isClient: false,
            timestamp: '2023-05-10 14:42',
        },
    ],
});
