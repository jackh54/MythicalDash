            ...
            <template #body>
                <form @submit.prevent="createNewTicket" class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="subject" v-model="newTicket.subject"
                    ...
                    <div>
                        ...
                        <textarea id="description" v-model="newTicket.description" rows="4"
                            class="mt-1 block w-full bg-gray-800/50 border border-gray-700/50 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm"
                            required></textarea>
                    </div>
...
const createNewTicket = () => {
    ...
    tickets.value.unshift({
        ...
        status: 'Open',
        lastUpdated: new Date().toISOString().split('T')[0] + ' ' + new Date().toTimeString().split(' ')[0].slice(0, 5)
    })
